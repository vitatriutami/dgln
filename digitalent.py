...
# ---- PROJECT ----
    ...
    # ---- LOAD ASSETS ----
    lottie_header = load_lottiefile("./Lottie/aviation.json")
    lottie_cs = load_lottiefile("./Lottie/analyst.json")
    lottie_hp = load_lottiefile("./Lottie/isometric-plane.json")
    lottie_navy = load_lottiefile("./Lottie/travel-aviation.json")
